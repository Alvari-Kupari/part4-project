...
public class BreakingChange {
    ...
    public static class Builder {
        ...
        public Builder libraryName(String libraryName) { this.libraryName = libraryName; return this; }
        public Builder oldVersion(String oldVersion) { this.oldVersion = oldVersion; return this; }
        public Builder newVersion(String newVersion) { this.newVersion = newVersion; return this; }
        public Builder isBinaryCompatible(boolean isBinaryCompatible) { this.isBinaryCompatible = isBinaryCompatible; return this; }
        public Builder isSourceCompatible(boolean isSourceCompatible) { this.isSourceCompatible = isSourceCompatible; return this; }
    ...
    public String toString() {
        return String.format("BreakingChange{library='%s', %s->%s, class='%s', member='%s', type='%s', compatible=binary:%s/source:%s}",
                libraryName, oldVersion, newVersion, className, memberName, changeType, isBinaryCompatible, isSourceCompatible);
    }
}
