...
/**
 * Test class to verify the client analysis functionality works correctly. This can be used to
 * manually test specific scenarios and debug the analysis.
 */
public class ClientAnalysisTest {
  ...
  public static void testWithJUnitExample() throws Exception {
    ...
    try {
      ...
      AllBreakingChangesCsvWriter allWriter =
          new AllBreakingChangesCsvWriter(testDir.resolve("junit-all-breaking-changes.csv"));
