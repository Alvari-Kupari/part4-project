...
/**
 * Example demonstrating how to use the BreakingChangeAnalyzer to detect breaking changes
 * between two versions of a dependency.
 */
public class BreakingChangeExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<BreakingChange> breakingChanges = analyzer.analyzeBreakingChanges(oldVersion, newVersion);
